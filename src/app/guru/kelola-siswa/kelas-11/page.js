...
// Mock data untuk siswa kelas 11 dengan detail lengkap
const mockStudentsKelas11 = [
  {
    id: 1,
    name: "Ahmad Zaki Rahman",
    nis: "2023001",
    kelas: "XI IPA 1",
    targetHafalan: "Juz 30, 29, 28",
    progressHafalan: 85,
    totalJuz: 2.8,
    status: "Aktif",
    ...
    detailHafalan: [
      { tanggal: "27 Sep 2025", surah: "Al-Mulk", ayat: "10-15", status: "Diterima", nilai: "A" },
      { tanggal: "26 Sep 2025", surah: "At-Tahrim", ayat: "8-12", status: "Diterima", nilai: "A-" },
      { tanggal: "25 Sep 2025", surah: "At-Talaq", ayat: "1-5", status: "Diterima", nilai: "A" },
      { tanggal: "24 Sep 2025", surah: "At-Taghabun", ayat: "14-18", status: "Diterima", nilai: "B+" },
      { tanggal: "23 Sep 2025", surah: "Al-Munafiqun", ayat: "9-11", status: "Diterima", nilai: "A" }
    ]
  },
  {
    id: 2,
    ...
    detailHafalan: [
      { tanggal: "27 Sep 2025", surah: "An-Nur", ayat: "35-40", status: "Diterima", nilai: "A+" },
      { tanggal: "26 Sep 2025", surah: "Al-Mu'minun", ayat: "115-118", status: "Diterima", nilai: "A" },
      { tanggal: "25 Sep 2025", surah: "Al-Hajj", ayat: "73-78", status: "Diterima", nilai: "A+" },
      { tanggal: "24 Sep 2025", surah: "Al-Anbiya", ayat: "105-112", status: "Diterima", nilai: "A" },
      { tanggal: "23 Sep 2025", surah: "Taha", ayat: "125-135", status: "Diterima", nilai: "A-" }
    ]
  },
  {
    id: 3,
    ...
    detailHafalan: [
      { tanggal: "26 Sep 2025", surah: "Al-Anbiya", ayat: "105-112", status: "Perlu Perbaikan", nilai: "C+" },
      { tanggal: "25 Sep 2025", surah: "Taha", ayat: "125-135", status: "Diterima", nilai: "B+" },
      { tanggal: "24 Sep 2025", surah: "Maryam", ayat: "95-98", status: "Diterima", nilai: "B" },
      { tanggal: "23 Sep 2025", surah: "Al-Kahf", ayat: "100-110", status: "Diterima", nilai: "B+" }
    ]
  }
];

export default function KelolaKelas11() {
  const [students, setStudents] = useState(mockStudentsKelas11);
  ...
  const handleAddStudent = (e) => {
    ...
    setNewStudent({ name: '', nis: '', kelas: 'XI IPA 1', targetHafalan: 'Juz 30, 29, 28' });
  ...
  const handleExportReport = (student) => {
    const reportData = `
LAPORAN HAFALAN SISWA KELAS 11
===============================
...
Laporan dibuat pada: ${new Date().toLocaleDateString('id-ID', { 
  ...
  day: 'numeric' 
    ...
    a.href = url;
    a.download = `Laporan_Hafalan_Kelas11_${student.name.replace(/\s+/g, '_')}.txt`;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#1F1F1F] mb-2">Kelola Siswa Kelas 11</h1>
        <p className="text-gray-600">Manajemen siswa kelas XI tahfidz</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold">Daftar Siswa Kelas 11</h2>
            <button
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">Tambah Siswa Kelas 11</h3>
            ...
            <form onSubmit={handleAddStudent} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Juz 30, 29, 28, 27">Juz 30, 29, 28, 27</option>
                  <option value="Juz 30, 29, 28, 27, 26">Juz 30, 29, 28, 27, 26</option>
                </select>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold">Detail Siswa Kelas 11</h3>
                <button 
