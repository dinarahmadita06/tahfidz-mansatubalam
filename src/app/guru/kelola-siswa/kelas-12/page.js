...
// Mock data untuk siswa kelas 12 dengan detail lengkap
const mockStudentsKelas12 = [
  {
    id: 1,
    name: "Abdullah bin Mas'ud",
    nis: "2022001",
    kelas: "XII IPA 1",
    targetHafalan: "15 Juz",
    progressHafalan: 93,
    totalJuz: 14.2,
    status: "Aktif",
    ...
    detailHafalan: [
      { tanggal: "27 Sep 2025", surah: "Yusuf", ayat: "100-111", status: "Diterima", nilai: "A+" },
      { tanggal: "26 Sep 2025", surah: "Hud", ayat: "120-123", status: "Diterima", nilai: "A" },
      { tanggal: "25 Sep 2025", surah: "Yunus", ayat: "105-109", status: "Diterima", nilai: "A" },
      { tanggal: "24 Sep 2025", surah: "At-Taubah", ayat: "125-129", status: "Diterima", nilai: "A-" },
      { tanggal: "23 Sep 2025", surah: "Al-Anfal", ayat: "70-75", status: "Diterima", nilai: "A+" }
    ]
  },
  {
    id: 2,
    ...
    detailHafalan: [
      { tanggal: "27 Sep 2025", surah: "Al-Baqarah", ayat: "280-286", status: "Diterima", nilai: "A+" },
      { tanggal: "26 Sep 2025", surah: "Al-Baqarah", ayat: "270-279", status: "Diterima", nilai: "A+" },
      { tanggal: "25 Sep 2025", surah: "Al-Baqarah", ayat: "260-269", status: "Diterima", nilai: "A" },
      { tanggal: "24 Sep 2025", surah: "Al-Baqarah", ayat: "250-259", status: "Diterima", nilai: "A+" },
      { tanggal: "23 Sep 2025", surah: "Al-Baqarah", ayat: "240-249", status: "Diterima", nilai: "A" }
    ]
  },
  {
    id: 3,
    ...
    detailHafalan: [
      { tanggal: "26 Sep 2025", surah: "Ibrahim", ayat: "40-52", status: "Diterima", nilai: "B+" },
      { tanggal: "25 Sep 2025", surah: "Ar-Ra'd", ayat: "40-43", status: "Diterima", nilai: "A-" },
      { tanggal: "24 Sep 2025", surah: "Yusuf", ayat: "90-99", status: "Diterima", nilai: "A" },
      { tanggal: "23 Sep 2025", surah: "Hud", ayat: "110-119", status: "Diterima", nilai: "B+" }
    ]
  },
  {
    id: 4,
    ...
    detailHafalan: [
      { tanggal: "27 Sep 2025", surah: "Al-Hijr", ayat: "85-99", status: "Diterima", nilai: "A" },
      { tanggal: "26 Sep 2025", surah: "Ibrahim", ayat: "50-52", status: "Diterima", nilai: "A-" },
      { tanggal: "25 Sep 2025", surah: "Ar-Ra'd", ayat: "35-43", status: "Diterima", nilai: "A" },
      { tanggal: "24 Sep 2025", surah: "Yusuf", ayat: "80-89", status: "Diterima", nilai: "A+" }
    ]
  }
];

export default function KelolaKelas12() {
  const [students, setStudents] = useState(mockStudentsKelas12);
  ...
  const handleAddStudent = (e) => {
    ...
    setNewStudent({ name: '', nis: '', kelas: 'XII IPA 1', targetHafalan: '10 Juz' });
  ...
  const handleExportReport = (student) => {
    const reportData = `
LAPORAN HAFALAN SISWA KELAS 12
===============================
...
Laporan dibuat pada: ${new Date().toLocaleDateString('id-ID', { 
  ...
  day: 'numeric' 
    ...
    a.href = url;
    a.download = `Laporan_Hafalan_Kelas12_${student.name.replace(/\s+/g, '_')}.txt`;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#1F1F1F] mb-2">Kelola Siswa Kelas 12</h1>
        <p className="text-gray-600">Manajemen siswa kelas XII tahfidz - Persiapan Wisuda</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold">Daftar Siswa Kelas 12</h2>
            <button
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">Tambah Siswa Kelas 12</h3>
            ...
            <form onSubmit={handleAddStudent} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="30 Juz">30 Juz (Full Quran)</option>
                </select>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold">Detail Siswa Kelas 12</h3>
                <button 
              ...
              <div className="bg-gradient-to-r from-[#FFB030] to-[#874D14] text-white rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm opacity-75 mt-2">🎓 Calon Wisudawan</p>
                  </div>
