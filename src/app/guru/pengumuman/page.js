          ...
          <div className="relative px-8 py-12 sm:px-12 sm:py-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm mt-2">Informasi dan kabar terbaru untuk guru</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border-2 border-green-100 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-12">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-xs mt-3">Admin akan segera mengirimkan informasi penting untuk guru</p>
            </div>
          </div>
        ) : (
          <div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 sm:p-8">
                      ...
                      <div className="flex items-start justify-between gap-4 mb-4">
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-gray-900 text-base line-clamp-2 group-hover:text-green-700 transition-colors">
                              {item.judul}
                            </h3>
                          </div>
                        </div>
                      ...
                      {/* Kategori Badge */}
                      <div className="mb-4">
                        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-200">
