                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      disabled={!token}
                      className={`w-full pl-12 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-emerald-300 focus:border-transparent transition-all disabled:bg-gray-100 disabled:cursor-not-allowed ${
