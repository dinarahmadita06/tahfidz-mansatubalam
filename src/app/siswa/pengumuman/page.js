          ...
          <div className="relative px-8 py-12 sm:px-12 sm:py-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-white/90 text-lg mt-2">Jangan lewatkan informasi penting dan kabar terbaru</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border-2 border-emerald-100 bg-gradient-to-br from-emerald-50 via-amber-50 to-cyan-50 p-12">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mt-3">Admin akan segera mengirimkan informasi penting untuk kamu</p>
            </div>
          </div>
        ) : (
          <div>
