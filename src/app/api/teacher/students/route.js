...
export async function POST(request) {
  try {
    ...
    if (parentMode === 'NEW' && (!parent || !parent.name || !parent.phone || !parent.email || !parent.password)) {
      return NextResponse.json({ error: 'Data orang tua baru tidak lengkap' }, { status: 400 });
    }
