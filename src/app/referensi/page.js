                    ...
                    <div className={`${!showSurahContent ? 'hidden md:block' : ''} p-4 md:p-6`}>
                      ...
                      {!loading && surahData && (
                        <div className="space-y-6">
                          ...
                          <div ref={versesPanelRef} className="bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 p-6 sm:p-8 text-white rounded-2xl shadow-[0_0_0_1px_rgba(16,185,129,0.3),0_8px_24px_rgba(16,185,129,0.15)]">
